...
!function(t){function s(t,s){return'<i class="fa fa-'+s+'"></i> '+t}var i=function(s,i,n){this.button=t(s),this.originalContent=this.button.html(),this.successMessage=i||"Success!",this.successIcon=n||"thumbs-o-up",this.button.height(this.button.height()),this.button.width(this.button.width());var u=this.defaultSpinner;this.button.html(u)};i.prototype={defaultSpinner:'<div class="spinner"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div>',reset:function(){this.button.html(this.originalContent)},success:function(){var t=s(this.successMessage,this.successIcon);this.button.html(t)}},window.LoadingButton=i}(jQuery);
!function(e){e("body").on("click",".share-btn",function(t){t.preventDefault();var n=e(this),r=n.data("href")||window.location.toString(),o=new LoadingButton(n,"Awesome!","thumbs-o-up fa-2x");FB.ui({method:"share",href:r,mobile_iframe:!0},function(e){e&&!e.hasOwnProperty("error")?o.success():o.reset()})}).on("click",".story-btn",function(t){t.preventDefault();var n=e(this),r=n.data("action"),o=n.data("celebrity"),a=new LoadingButton(n,"Awesome!","thumbs-o-up fa-2x");FB.api("me/"+r,"post",{celebrity:o,access_token:userAccessToken},function(e){e&&!e.hasOwnProperty("error")&&e.hasOwnProperty("id")?a.success():(a.reset(),Alerts.add("danger","Sorry, something went wrong. Please refresh the page and try again later","exclamation-triangle",!0))})})}(jQuery);
