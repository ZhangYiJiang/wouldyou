...
!function(t){t("body").on("click",".share-btn",function(e){e.preventDefault();var o=t(this),n=o.data("href")||window.location.toString();FB.ui({method:"share",href:n,mobile_iframe:!0})}).on("click",".story-btn",function(e){e.preventDefault();var o=t(this),n=o.data("action");FB.api("me/"+n,"post",{celebrity:'"http://samples.ogp.me/179233982498817"'},function(t){console.log(t)})})}(jQuery);
