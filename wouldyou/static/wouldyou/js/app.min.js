...
!function(t){function n(n){return function(e){e.preventDefault();var r=t(this),i=n(r);FB.ui(i)}}t("body").on("click",".share-btn",n(function(t){return{method:"share",href:t.data("href")||window.location.toString(),mobile_iframe:!0}})).on("click",".story-btn",n(function(t){return{method:"share_open_graph",action_type:t.data("action"),action_properties:JSON.stringify({celebrity:t.data("celebrity")})}}))}(jQuery);
