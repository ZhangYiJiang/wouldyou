...
!function(e){e("body").on("click",".share-btn",function(t){t.preventDefault();var o=e(this),n=o.data("href")||window.location.toString();FB.ui({method:"share",href:n,mobile_iframe:!0})}).on("click",".story-btn",function(t){t.preventDefault();var o=e(this),n=o.data("action");JSON.stringify({type:"og:celebrity"});FB.api("me/"+n,"post",{celebrity:'"http://samples.ogp.me/179233982498817"',access_token:userAccessToken},function(e){console.log(e)})})}(jQuery);
