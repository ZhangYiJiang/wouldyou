...
!function(t){function s(t,s){return'<i class="fa fa-'+s+'"></i> '+t}var i=function(s,i,n){this.button=t(s),this.originalContent=this.button.html(),this.successMessage=i||"Success!",this.successIcon=n||"thumb-o-up",this.button.height(this.button.height()),this.button.width(this.button.width());var u=this.defaultSpinner;this.button.html(u)};i.prototype={defaultSpinner:'<div class="spinner"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div>',reset:function(){this.button.html(this.originalContent)},success:function(){var t=s(this.successIcon,this.successMessage);this.button.html(t)}},window.LoadingButton=i}(jQuery);
!function(e){e("body").on("click",".share-btn",function(t){t.preventDefault();var n=e(this),o=n.data("href")||window.location.toString(),r=new LoadingButton(n);FB.ui({method:"share",href:o,mobile_iframe:!0},function(e){e&&!e.hasOwnProperty("error")?r.success():r.reset()})}).on("click",".story-btn",function(t){t.preventDefault();var n=e(this),o=n.data("action"),r=n.data("celebrity"),s=new LoadingButton(n);FB.api("me/"+o,"post",{celebrity:r,access_token:userAccessToken},function(e){console.log(e),e&&!e.hasOwnProperty("error")&&e.hasOwnProperty("id")?s.success():s.reset()})})}(jQuery);
