...
!function(e){e("body").on("click",".share-btn",function(t){t.preventDefault();var o=e(this),n=o.data("href")||window.location.toString(),r=new LoadingButton(o);FB.ui({method:"share",href:n,mobile_iframe:!0},function(e){console.log(e),e&&!e.hasOwnProperty("error")?r.success():r.reset()})}).on("click",".story-btn",function(t){t.preventDefault();var o=e(this),n=o.data("action"),r=o.data("celebrity"),a=new LoadingButton(o);FB.api("me/"+n,"post",{celebrity:r,access_token:userAccessToken},function(e){console.log(e),e&&!e.hasOwnProperty("error")&&e.hasOwnProperty("id")?a.complete():a.reset()})})}(jQuery);
