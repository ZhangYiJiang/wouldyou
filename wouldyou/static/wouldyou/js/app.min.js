...
if(function(e){var t=3,a=function(t){var a=this;this.gameArea=e(t),this.gameForm=t.find("form"),this.buttons=this.gameArea.find(".verb-btn"),this.selected=[],this.completed=!1,this.gameArea.on("click",".verb-btn",function(t){t.preventDefault(),a.select(e(this))}),this.gameArea.find(".undo-btn").click(function(e){e.preventDefault(),a.undo()}),this.gameForm.submit(function(e){if(!a.completed)return!1})};a.prototype={undo:function(){this.selected=[],this.gameArea.find(".game-card").removeClass("card-selected").addClass("card-unselected"),this.buttons.removeClass("disabled"),this.gameArea.find(".game-card input").prop("checked",!1),this.gameArea.find(".overlay-image").children().hide()},select:function(a){var i=a.data("verb");if(this.selected.indexOf(i)===-1){this.selected.push(i),this.otherButtons(a).addClass("disabled");var s=a.closest(".game-card").removeClass("card-unselected").addClass("card-selected");a.next("input").prop("checked",!0),s.find(".overlay-image").children().filter(function(){return e(this).data("verb")==i}).fadeIn(),this.selected.length===t&&this.complete()}},otherButtons:function(t){var a=t.data("verb");return this.buttons.not(t).filter(function(){return e(this).data("verb")===a})},complete:function(){this.completed=!0,this.gameArea.find(".skip-btn").hide(),this.gameArea.find(".next-btn").removeClass("hidden"),this.gameArea.addClass("game-complete")}},window.Game=a}(jQuery),$("body").hasClass("game"))var game=new Game($(".game-area"));
