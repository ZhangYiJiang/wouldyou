...
!function(e){var t=e("body.game .verb-button"),a=e("body.game .game-area"),s=a.data("url"),d=a.data("set"),i=a.data("model");t.click(function(a){a.preventDefault();var c=e(this);if(!c.data("clicked")){c.data("clicked",!0);var r=c.data("verb");t.not(this).filter(function(){return e(this).data("verb")==r}).css("visibility","hidden"),c.closest("li").siblings().find("button").remove(),c.closest(".game-card-unselected").removeClass("game-card-unselected");var l=c.closest(".game-card").data("subject");e.post(s,{set:d,model:i,verb:r,subject:l}).fail(function(){})}})}(jQuery);
