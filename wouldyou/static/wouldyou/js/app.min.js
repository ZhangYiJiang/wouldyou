...
!function(t){function e(e,a,r,n){var i=t("<div>",{class:"alert alert-"+e});return t("<p>",{text:a}).appendTo(i),r&&t("<i>",{class:"fa fa-"+r}).prependTo(i),i}var a=t(".alert-container");if(a.length){var r=function(){var e=this;this.alerts=[],this.alertArea=a,this.alertArea.children().each(function(){e.alerts.push(t(this))})};r.prototype={add:function(t,a,r,n){var i=e(t,a,r,n);i.hide().slideDown(),this.alerts.push(i),this.alertArea.append(i)}},window.Alerts=new r}}(jQuery);
!function(e){e("body").on("click",".share-btn",function(t){t.preventDefault();var i=e(this),n=i.data("href")||window.location.toString();FB.ui({method:"share",href:n,mobile_iframe:!0})})}(jQuery);
