...
!function(t){function n(n){return function(e){e.preventDefault();var i=t(this),o=n(i);FB.ui(o)}}t("body").on("click",".share-btn",n(function(t){return{method:"share",href:t.data("href")||window.location.toString(),mobile_iframe:!0}})).on("click",".story-btn",n(function(t){return{method:"share_open_graph",mobile_iframe:!0,action_type:t.data("action"),action_properties:JSON.stringify({object:t.data("celebrity")})}}))}(jQuery);
