...
!function(e){e(".invite-btn").click(function(n){n.preventDefault();var i=e(this),t=i.data("url"),o=i.data("message"),s=e(".bg-container"),a=new BlockUi(s);FB.ui({method:"apprequests",message:o},function(n){return!n||"error_code"in n?void a.hide():void e.post(t,{response:n}).success({}).fail(function(){}).always(function(){a.hide()})})})}(jQuery);
