...
Object.values=Object.values||function(t){for(var e in t)if(Object.prototype.hasOwnProperty.call(t,e))var o=t[e];return o},$.ajaxSetup({headers:{"X-CSRFToken":$('meta[name="csrf_token"]').attr("content")}}),function(t){var e=t("#block-ui").clone().removeAttr("id").removeClass("hidden").hide(),o=function(o,n){this.block=e.clone(),this.parent=t(o),this.parent.append(this.block),this.show()};o.prototype={hide:function(e){this.block.fadeOut(300,function(){t(this).remove()})},show:function(t){this.block.fadeIn(300)}},window.BlockUi=o}(jQuery);
...
!function(t){function s(t,s){return'<i class="fa fa-'+s+'"></i> '+t}var n=function(s,n,i){this.button=t(s),this.originalContent=this.button.html(),this.successMessage=n||"Success!",this.successIcon=i||"thumbs-o-up"};n.prototype={defaultSpinner:'<div class="spinner"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div>',start:function(){if(this.button.data("started"))return!1;this.button.height(this.button.height());var t=this.defaultSpinner;return this.button.html(t),this.button.addClass("btn-started").data("started",!0),!0},reset:function(){this.button.html(this.originalContent),this.button.removeClass("btn-started").data("started",!1)},success:function(){var t=s(this.successMessage,this.successIcon);this.button.html(t)}},window.LoadingButton=n}(jQuery);
!function(e){e("body").on("click",".share-btn",function(r){r.preventDefault();var t=e(this),n=t.data("href")||window.location.toString(),a=new LoadingButton(t,"Awesome!","check");a.start()&&FB.ui({method:"share",href:n,mobile_iframe:!0},function(e){e&&!e.hasOwnProperty("error")?a.success():a.reset()})}).on("click",".story-btn",function(r){r.preventDefault();var t=e(this),n=t.data("action"),a=t.data("celebrity"),o=new LoadingButton(t,"Awesome!","check fa-2x");o.start()&&FB.api("me/"+n,"post",{celebrity:a,access_token:userAccessToken},function(e){e&&!e.hasOwnProperty("error")&&e.hasOwnProperty("id")?o.success():e.hasOwnProperty("error")&&3501==e.error.code?o.success():(o.reset(),AlertManager.add("danger","Sorry, something went wrong. Please refresh the page and try again later","exclamation-triangle",!0))})})}(jQuery);
!function(e){e(".invite-btn").click(function(r){r.preventDefault();var n=e(this),a=n.data("url"),t=n.data("message"),i=e(".bg-container"),o=new BlockUi(i);FB.ui({method:"apprequests",message:t,filters:["app_non_users"]},function(r){return!r||"error_code"in r||Array.isArray(r)&&!r.length?void o.hide():void e.post(a,{response:r}).done(function(r){r.success||console.error(r);var a=r.data;if(a.hasOwnProperty("redirect"))n.data("no-redirect")?(AlertManager.clear(),AlertManager.add("info","Your friends have been successfully added!","info-circle")):window.location.href=a.redirect;else if(a.hasOwnProperty("required_count")){var t=a.required_count;e(".invite-count").text(t),AlertManager.clear("danger");var i="Sorry, you didn't invite enough friends. Please invite "+t+" or more friends to continue playing.";AlertManager.add("danger",i,"exclamation-triangle")}}).fail(function(){AlertManager.add("danger","Oops! Something seems to have went wrong. Please refresh and try again","exclamation-triangle")}).always(function(){o.hide()})})})}(jQuery);
if(function(e){var t=3,i=function(t){var i=this;this.gameArea=e(t),this.gameForm=t.find("form"),this.buttons=this.gameArea.find(".verb-btn"),this.selected=[],this.completed=!1,this.gameCards=this.gameArea.find(".game-card"),this.playerImages=this.gameCards.children("img"),this.gameArea.on("click",".verb-btn",function(t){t.preventDefault(),i.select(e(this))}),this.gameArea.find(".undo-btn").click(function(e){e.preventDefault(),i.undo()}),this.gameForm.submit(function(e){if(!i.completed)return!1}),this.playerImages.imagesLoaded(function(){i.fixImageSize(),e(window).scroll()}),this.resizeTimeoutId=!1,e(window).on("resize",function(){i.resizeTimeoutId!==!1&&clearTimeout(i.resizeTimeoutId),i.resizeTimeoutId=setTimeout(function(){i.playerImages.prop("style",""),i.fixImageSize(),i.resizeTimeoutId=!1},50)}),e(window).on("scroll",function(){var t=i.gameArea.find(".game-controls"),s=i.gameArea.outerHeight(!0)+i.gameArea.offset().top+t.height(),a=e(window).height()+e(window).scrollTop();t.toggleClass("sticky-bottom",s<a)}).scroll()};i.prototype={showLikeAlertAfter:5,undo:function(){this.selected={},this.gameArea.find(".game-card").removeClass("card-selected").addClass("card-unselected"),this.buttons.prop("disabled",!1).removeClass("disabled"),this.gameArea.find(".game-card input").prop("checked",!1),this.gameArea.find(".overlay-image").children().hide()},select:function(i){var s=i.data("verb"),a=i.closest(".game-choice").prevAll(".game-choice").length;if(!this.selected.hasOwnProperty(a)&&!Object.values(this.selected).includes(s)){this.selected[a]=s,this.otherButtons(i).addClass("disabled").prop("disabled",!0);var n=i.closest(".game-card").removeClass("card-unselected").addClass("card-selected");i.next("input").prop("checked",!0),n.find(".overlay-image").children().filter(function(){return e(this).data("verb")==s}).fadeIn(),Object.keys(this.selected).length===t&&this.complete()}},otherButtons:function(t){var i=t.data("verb");return this.buttons.not(t).filter(function(){return e(this).data("verb")===i})},complete:function(){var t=this,i=[];this.completed=!0,this.gameArea.find(".undo-btn").fadeOut(),this.gameArea.find(".skip-btn").hide(),this.gameArea.find(".next-btn").removeClass("hidden"),this.gameCards.each(function(s){var a=e(this),n=t.selected[s],o=a.find('.game-story[data-verb="'+n+'"]').removeClass("hidden");o.length||i.push(a.find(".friend-stories").data("subject"))}),setTimeout(this.showResults.bind(this),400),i.length&&setTimeout(function(){t.showMatchModal(i)},500),setTimeout(this.showLikeAlert.bind(this),1800)},showResults:function(){this.gameArea.find(".game-card").each(function(t,i){setTimeout(function(){e(i).find(".game-result").fadeIn(300)},400*t)})},showMatchModal:function(t){var i=e(".match-modal");i.find(".player-match").filter(function(){return t.includes(e(this).data("subject"))}).removeClass("hidden"),i.find(".match-btn").click(function(){e.featherlight.close()}),e.featherlight(i)},showLikeAlert:function(){if(!Cookies.get("like_alert_dismissed")){var t=+Cookies.get("complete_count")||0;if(t>this.showLikeAlertAfter){var i=e("footer.global .fb-like").get(0).outerHTML,s="Having fun? Why not spread the word by giving us a like? ";AlertManager.add("info",s+i,"thumbs-o-up",function(){Cookies.set("like_alert_dismissed",!0,{expires:365})})}else Cookies.set("complete_count",t+1,{expires:365})}},fixImageSize:function(){var t=this.playerImages.map(function(){return e(this).height()}).get(),i=this.playerImages.map(function(){return e(this).width()}).get(),s=Math.max.apply(null,t),a=Math.max.apply(null,i);this.playerImages.height(s).width(a)}},window.Game=i}(jQuery),$("body").hasClass("game"))var game=new Game($(".game-area"));
