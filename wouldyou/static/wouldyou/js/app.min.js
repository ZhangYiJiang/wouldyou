...
!function(e){e("body").on("click",".share-btn",function(t){t.preventDefault();var n=e(this),o=n.data("href")||window.location.toString();FB.ui({method:"share",href:o,mobile_iframe:!0})}).on("click",".story-btn",function(t){t.preventDefault();var n=e(this),o=n.data("action"),i=n.data("celebrity");FB.api("me/"+o,"post",{celebrity:i,access_token:userAccessToken},function(e){console.log(e)})})}(jQuery);
